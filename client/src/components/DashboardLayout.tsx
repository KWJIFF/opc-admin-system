...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    label: "内容管理",
    items: [
      { icon: Radar, label: "情报中心", path: "/admin/signals" },
      { icon: Lightbulb, label: "选题中心", path: "/admin/topics" },
      { icon: FileText, label: "内容工厂", path: "/admin/contents" },
      { icon: CheckCircle, label: "审核台", path: "/admin/reviews" },
      { icon: Send, label: "发布台", path: "/admin/publish" },
    ],
  },
  {
    label: "分发与运营",
    items: [
      { icon: Share2, label: "账号托管", path: "/admin/accounts" },
      { icon: Calendar, label: "内容日历", path: "/admin/calendar" },
      { icon: Globe, label: "网站文章", path: "/admin/website" },
      { icon: BarChart3, label: "报告中心", path: "/admin/reports" },
    ],
  },
  {
    label: "智能工具",
    items: [
      { icon: TrendingUp, label: "数据洞察", path: "/admin/insights" },
      { icon: Bot, label: "AI 互动管理", path: "/admin/ai-interactions" },
      { icon: RefreshCw, label: "数据循环建议", path: "/admin/data-loop" },
      { icon: Workflow, label: "工作流", path: "/admin/workflows" },
      { icon: Clock, label: "AI 自动化任务", path: "/admin/scheduler" },
    ],
  },
  {
    label: "用户运营",
    items: [
      ...
      { icon: Mail, label: "订阅管理", path: "/admin/subscribers" },
    ],
  },
  {
    label: "系统管理",
    items: [
      { icon: Users, label: "团队成员", path: "/admin/team" },
      { icon: Shield, label: "权限管理", path: "/admin/permissions" },
      { icon: Activity, label: "系统监控", path: "/admin/monitor" },
      { icon: Database, label: "来源管理", path: "/admin/sources" },
