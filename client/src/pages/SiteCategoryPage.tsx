      ...
      <Link href={`/site/article/${article.id}`}>
        <div className="group flex items-start gap-3 sm:gap-4 p-3.5 sm:p-5 rounded-xl bg-card border border-border/40 hover:border-primary/20 hover:shadow-md transition-all duration-300 cursor-pointer active:scale-[0.99]">
          <div className="flex-1 min-w-0">
            <h3 className="text-[15px] sm:text-base font-medium text-foreground group-hover:text-primary transition-colors leading-snug mb-1.5 sm:mb-2 line-clamp-2">
              {article.title}
            </h3>
            <p className="text-[13px] sm:text-sm text-muted-foreground leading-relaxed line-clamp-2 mb-2.5 sm:mb-3">
              {article.summary}
            </p>
    ...
    >
      <Link href={`/site/article/${article.id}`}>
        <div className="group relative p-5 sm:p-6 lg:p-8 rounded-2xl bg-card border border-border/50 card-elevated cursor-pointer active:scale-[0.99] transition-transform">
          ...
          <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-foreground group-hover:text-primary transition-colors mb-2 sm:mb-3 leading-snug max-w-3xl">
            {article.title}
          </h2>
          <p className="text-muted-foreground text-[13px] sm:text-sm lg:text-base leading-relaxed max-w-3xl mb-4 sm:mb-5 line-clamp-3">
            {article.summary}
          </p>
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      ...
      <motion.div
        ...
        className="pt-2 sm:pt-4 pb-8 sm:pb-10 lg:pb-14"
      >
        <div className="flex items-center gap-2.5 sm:gap-3 mb-3 sm:mb-4">
          ...
          <div>
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-widest text-primary/60 block">{cat.tag}</span>
