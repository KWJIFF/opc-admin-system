...
export default function SiteAbout() {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      {/* Hero */}
      <section className="pt-8 sm:pt-16 pb-16 sm:pb-24 text-center">
        <motion.div
        ...
        >
          <img src={LOGO_URL} alt="深象科技" className="h-14 w-14 rounded-2xl mx-auto mb-6" />
      ...
      <section className="pb-20">
        <motion.div
          ...
          className="rounded-2xl p-8 sm:p-12 bg-card border border-border/50 card-elevated text-center"
        >
          <span className="text-[11px] font-semibold uppercase tracking-widest text-primary/60 mb-4 block">OUR MISSION</span>
      ...
      <section className="pb-20">
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3">核心价值观</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {values.map((v, i) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-card border border-border/50 card-elevated"
            >
              <div className="p-2.5 rounded-xl bg-primary/6 text-primary w-fit mb-4">
      ...
      <section className="pb-20">
        <motion.div
          ...
          className="text-center mb-12"
        >
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3">发展历程</h2>
        </motion.div>
            ...
            >
              ...
              <div className="relative pt-1">
                ...
                {i < milestones.length - 1 && (
                  <div className="absolute left-[3px] top-4 w-0.5 h-full bg-border/60" />
                )}
              </div>
              <p className="text-foreground text-sm leading-relaxed pl-3 pb-4">{m.event}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="pb-12">
        <motion.div
          ...
          viewport={{ once: true, margin: "-60px" }}
          transition={{ duration: 0.5 }}
          className="rounded-2xl p-8 sm:p-12 bg-secondary/30 border border-border/30 text-center"
        >
          <h2 className="text-2xl font-bold text-foreground mb-6">联系我们</h2>
